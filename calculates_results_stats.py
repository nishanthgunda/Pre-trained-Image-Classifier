...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        #Count for labels match
        if results_dic[key][2] == 1:
            results_stats_dic['n_match']+=1
            
        #Count for breed correctly classified
        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
            results_stats_dic['n_correct_breed']+=1
            
        #Count for number of dog images
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img']+=1
            #As pet image label is dog check for classifier label is a dog
    ...
    #Number of not-a-dog images using total images - dog images counts
